...
- Embedding = Repräsentation von Spracheinheiten (z.B.) in Vektorraum
    - Ähnliche Wörter liegen nah beieinaner 
- Embedding-Modelle sind LLMs, die für den Einsatz von Embeddings finetuned werden [@gunther_jina_2023]
- Text-Embedding: Durchschnitt der Token Embeddings im vorherigen Layer resultiert in einem Vektor
- Semantische Suche geschieht über Distanz zwischen Vektoren in Query und in Datenbank
...
- Ausführung von Tools geschieht im Hintergrund
- Chatbots als modulare Systeme (Beispiel Lupai)
    - Spezialisierte Modelle als Module
    - Festgelegte Logik vs. gewisser Grad an Autonomität
